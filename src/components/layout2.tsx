...
const Layout2 = () => {
  ...
  const treeFields = { dataSource: treeData, id: "id", text: "name", selected: "selected", parentID: "pid", hasChildren: "hasChild", expanded: "expanded" };
  ...
  return (<div className="control-section" id="sidebar-wrapper">
    ...
    <div className="maincontent">
      <ListViewComponent id="listView" ref={(ListView:any) => listObj = ListView} template={listTemplate} cssClass="e-list-template" dataSource={inboxData} fields={fields} select={onListSelect.bind(this)}>
      </ListViewComponent>
    </div>
    {/* end of main content declaration */}
    {/* sidebar element declaration */}
    <SidebarComponent id="defaultSidebar" ref={(Sidebar:any) => sidebarobj = Sidebar} className="default-sidebar" width="260px" target=".maincontent" position="Left">
      <TreeViewComponent id="defaultTree" 
      // fields={treeFields} 
      nodeSelecting={beforeSelect.bind(this)} nodeSelected={onSelect.bind(this)}>
      </TreeViewComponent>
    </SidebarComponent>
  </div>);
}
